...
namespace GDI
{
    public class TransformationMatrix
    {
        ...
        public static TransformationMatrix CreateDefault(Control control)
        {
            return new TransformationMatrix(control, new Rectangle(0, 0, control.ClientSize.Width - 1, control.ClientSize.Height - 1));
        }
